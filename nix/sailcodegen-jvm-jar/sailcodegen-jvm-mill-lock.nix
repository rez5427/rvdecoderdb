...
in
{
  ...
  "com.lihaoyi_geny_sjs1_2.13-1.1.0" = fetchMaven {
    name = "com.lihaoyi_geny_sjs1_2.13-1.1.0";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/geny_sjs1_2.13/1.1.0/geny_sjs1_2.13-1.1.0.jar" "https://repo1.maven.org/maven2/com/lihaoyi/geny_sjs1_2.13/1.1.0/geny_sjs1_2.13-1.1.0.pom" ];
    hash = "sha256-kG2oosEHRNP15BzIIgpy/qbNE1tioqARBiguGk+p5GU=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/geny_sjs1_2.13/1.1.0";
  };
  ...
  "com.lihaoyi_os-lib_2.13-0.9.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_2.13/0.9.1/os-lib_2.13-0.9.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_2.13/0.9.1/os-lib_2.13-0.9.1.pom" ];
  ...
  "com.lihaoyi_ujson_sjs1_2.13-3.3.1" = fetchMaven {
    name = "com.lihaoyi_ujson_sjs1_2.13-3.3.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/ujson_sjs1_2.13/3.3.1/ujson_sjs1_2.13-3.3.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/ujson_sjs1_2.13/3.3.1/ujson_sjs1_2.13-3.3.1.pom" ];
    hash = "sha256-PZeMf75al96n03VG1ZA92HikI+SPZ4BI5WxH9IqzvIo=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/ujson_sjs1_2.13/3.3.1";
  };
  ...
  "com.lihaoyi_upack_sjs1_2.13-3.3.1" = fetchMaven {
    name = "com.lihaoyi_upack_sjs1_2.13-3.3.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upack_sjs1_2.13/3.3.1/upack_sjs1_2.13-3.3.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/upack_sjs1_2.13/3.3.1/upack_sjs1_2.13-3.3.1.pom" ];
    hash = "sha256-7ZReBy2HP7M9w35lYOK4I1WyUNTzm+YDqBFTPNnkY7k=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/upack_sjs1_2.13/3.3.1";
  };
  ...
  "com.lihaoyi_upickle-core_sjs1_2.13-3.3.1" = fetchMaven {
    name = "com.lihaoyi_upickle-core_sjs1_2.13-3.3.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upickle-core_sjs1_2.13/3.3.1/upickle-core_sjs1_2.13-3.3.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/upickle-core_sjs1_2.13/3.3.1/upickle-core_sjs1_2.13-3.3.1.pom" ];
    hash = "sha256-i1Ch+lmsgG6bBscj6K7ghmWzjTZRqkDpYTFYsmRkT1I=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/upickle-core_sjs1_2.13/3.3.1";
  };
  ...
  "com.lihaoyi_upickle-implicits_sjs1_2.13-3.3.1" = fetchMaven {
    name = "com.lihaoyi_upickle-implicits_sjs1_2.13-3.3.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upickle-implicits_sjs1_2.13/3.3.1/upickle-implicits_sjs1_2.13-3.3.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/upickle-implicits_sjs1_2.13/3.3.1/upickle-implicits_sjs1_2.13-3.3.1.pom" ];
    hash = "sha256-zSG8hP4BFB4ZYgmTlEA4C2KU3uxHUhMqBnV0XsOWaEM=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/upickle-implicits_sjs1_2.13/3.3.1";
  };
  ...
  "com.lihaoyi_upickle_sjs1_2.13-3.3.1" = fetchMaven {
    name = "com.lihaoyi_upickle_sjs1_2.13-3.3.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upickle_sjs1_2.13/3.3.1/upickle_sjs1_2.13-3.3.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/upickle_sjs1_2.13/3.3.1/upickle_sjs1_2.13-3.3.1.pom" ];
    hash = "sha256-B3RpMVyxsMZirEJjQSlhKauL7VSsdnRTjq0jUazYtow=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/upickle_sjs1_2.13/3.3.1";
  };
  ...
  "org.scala-js_scalajs-compiler_2.13.15-1.14.0" = fetchMaven {
    name = "org.scala-js_scalajs-compiler_2.13.15-1.14.0";
    urls = [ "https://repo1.maven.org/maven2/org/scala-js/scalajs-compiler_2.13.15/1.14.0/scalajs-compiler_2.13.15-1.14.0.jar" "https://repo1.maven.org/maven2/org/scala-js/scalajs-compiler_2.13.15/1.14.0/scalajs-compiler_2.13.15-1.14.0.pom" ];
    hash = "sha256-xbV//Fp1u9txUKWxKWzxPS5KQ6HCcqybgf6I92vGya0=";
    installPath = "https/repo1.maven.org/maven2/org/scala-js/scalajs-compiler_2.13.15/1.14.0";
  };

  "org.scala-js_scalajs-javalib-1.14.0" = fetchMaven {
    name = "org.scala-js_scalajs-javalib-1.14.0";
    urls = [ "https://repo1.maven.org/maven2/org/scala-js/scalajs-javalib/1.14.0/scalajs-javalib-1.14.0.jar" "https://repo1.maven.org/maven2/org/scala-js/scalajs-javalib/1.14.0/scalajs-javalib-1.14.0.pom" ];
    hash = "sha256-Vg9c1U7zFYLWIXrqIskmNrW8w0g9+KA7A7UAJQiI9l4=";
    installPath = "https/repo1.maven.org/maven2/org/scala-js/scalajs-javalib/1.14.0";
  };

  "org.scala-js_scalajs-library_2.13-1.14.0" = fetchMaven {
    name = "org.scala-js_scalajs-library_2.13-1.14.0";
    urls = [ "https://repo1.maven.org/maven2/org/scala-js/scalajs-library_2.13/1.14.0/scalajs-library_2.13-1.14.0.jar" "https://repo1.maven.org/maven2/org/scala-js/scalajs-library_2.13/1.14.0/scalajs-library_2.13-1.14.0.pom" ];
    hash = "sha256-AgfsghbN/ugHhaDd8SRiqFmUbIKqVZGhGc+EBOEVhFg=";
    installPath = "https/repo1.maven.org/maven2/org/scala-js/scalajs-library_2.13/1.14.0";
  };
...
# Project Source Hash:sha256-Shkzek+Yy9U12HVDjaQDcwFTqMxNNdHLuCXeZ0zqctI=
